...
export const metadata: Metadata = {
  title: "Eesti Köök - Authentic Estonian Restaurant",
  description: "Experience traditional Estonian cuisine with authentic recipes, fresh ingredients, and warm hospitality. Book your table at Eesti Köök for an unforgettable Baltic dining experience.",
  keywords: "Estonian restaurant, Baltic cuisine, traditional Estonian food, authentic recipes, rye bread, Estonian meatballs, Tallinn cuisine, Nordic food, heritage dining",
  metadataBase: new URL("https://eestikook.com"),
  alternates: {
    canonical: "https://eestikook.com"
  },
  openGraph: {
    title: "Eesti Köök - Authentic Estonian Restaurant",
    description: "Experience traditional Estonian cuisine with authentic recipes and warm hospitality. Book your table today.",
    siteName: "Eesti Köök",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T5izMxldBWO3pvAnJwuKTzxAr/uploaded-1763413773385-hpmr7yb0.jpg",
      alt: "Estonian countryside with traditional wooden house"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Eesti Köök - Authentic Estonian Restaurant",
    description: "Experience traditional Estonian cuisine with authentic recipes and warm hospitality.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T5izMxldBWO3pvAnJwuKTzxAr/uploaded-1763413773385-hpmr7yb0.jpg"]
  },
  robots: {
    index: true,
    follow: true
